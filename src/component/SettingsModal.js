...
const SettingsModal = ({ show, onClose, devices, selectedDevice, setSelectedDevice, startCamera, previewVideoRef, stream, settings, setSettings, selectDirectory, directoryHandle, accessToken, driveFolders, createDriveFolder, showFolderQr, onOpenDrivePicker }) => {
  ...
  return (
    <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "rgba(0,0,0,0.5)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 1000 }}>
      <div className="custom-scrollbar" style={{ position: "relative", background: "#fff", padding: "30px", borderRadius: "12px", width: "90%", maxWidth: "500px", maxHeight: "90vh", overflowY: "auto", display: "flex", flexDirection: "column", gap: "15px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
